...
% If none is present the build stops and names all three. See README.md.
% Route 1 is taken only if all four files are present: a partial \jafontdir (an interrupted
% download, say) must fall through to the later routes rather than fail on a missing file.
\newif\ifnotocjkcomplete
\notocjkcompletetrue
\IfFileExists{\jafontdir/NotoSerifCJKjp-Regular.otf}{}{\notocjkcompletefalse}
\IfFileExists{\jafontdir/NotoSerifCJKjp-Bold.otf}{}{\notocjkcompletefalse}
\IfFileExists{\jafontdir/NotoSansCJKjp-Regular.otf}{}{\notocjkcompletefalse}
\IfFileExists{\jafontdir/NotoSansCJKjp-Bold.otf}{}{\notocjkcompletefalse}
...
\else
  \IfFontExistsTF{HaranoAjiMincho-Regular.otf}{%
    ...
    \IfFontExistsTF{Noto Serif CJK JP}{%
      ...
      \PackageError{mobius-cpt-note}{No Japanese font available}{%
        This document needs one of: (1) the four Noto CJK JP OTFs in the directory
        \jafontdir/ (see docs/note/README.md); (2) the haranoaji fonts, part of TeX Live
        2020 and later; (3) the Noto Serif/Sans CJK JP families installed system-wide and
